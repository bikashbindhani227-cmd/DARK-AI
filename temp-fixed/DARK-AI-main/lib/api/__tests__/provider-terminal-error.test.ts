...
describe("wrapProviderTerminalError", () => {
  ...
  it("distinguishes local aggregate-size rejections from upstream 413s", () => {
    const localAttempt = Object.assign(new Error("Request too large"), {
      statusCode: 413,
      responseHeaders: {
        "X-DARK AI-OpenRouter-Request-Size-Guard": "rejected",
        "X-DARK AI-OpenRouter-Request-Bytes-Before": "7083624",
        "X-DARK AI-OpenRouter-Request-Bytes-After": "6012345",
        "X-DARK AI-OpenRouter-Request-Limit-Bytes": "5242880",
        "X-DARK AI-Request-Id": "size-guard-1",
      },
    });
