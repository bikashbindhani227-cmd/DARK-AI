  ...
  z
    ...
    .describe(
      usesDeepSeekToolBrief(modelName)
        ...
        : "Optional display metadata. Include a concise one-sentence preamble whenever possible so the user understands the operation; if omitted, DARK AI will show a generated fallback label.",
    );
      ...
      ...(approvalGated
        ? {
            justification: z
              ...
              .optional()
              .describe(
                "A concise, user-facing reason shown in DARK AI's approval prompt. Explain the intended outcome rather than repeating the command.",
              ),
            prefix_rule: z
