...
const description =
  "Compare current DARK AI Free, Pro, Pro+, Ultra, and Team pricing for AI-assisted penetration testing, local Agent mode, files, and cloud agents.";

export const metadata: Metadata = {
  ...canonicalMetadata("/pricing"),
  title: "Pricing | DARK AI",
  description,
  openGraph: {
    title: "DARK AI Pricing",
    description,
    type: "website",
    url: "/pricing",
  },
