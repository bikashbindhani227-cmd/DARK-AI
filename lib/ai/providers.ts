...
//   them. DARK AI routes across providers between steps, so the visible
...
export const modelDisplayNames: Record<ModelName, string> &
  ...
  "ask-model": "Auto, an intelligent model router built by DARK AI",
  "ask-model-free": "Auto, an intelligent model router built by DARK AI",
  "agent-model": "Auto, an intelligent model router built by DARK AI",
  "agent-model-free": "Auto, an intelligent model router built by DARK AI",
  ...
  "fallback-agent-model": "Auto, an intelligent model router built by DARK AI",
  "fallback-ask-model": "Auto, an intelligent model router built by DARK AI",
...
/**
 * Map a DARK AI tier id to the underlying provider key for a given mode.
