...
export const SITE_NAME = "DARK AI";
export const SITE_URL = "https://yourdomain.com";
export const SITE_DESCRIPTION =
  "DARK AI is an AI agent for penetration testing that helps security practitioners investigate targets, use terminal and browser tools, analyze findings, and prepare reports.";
...
export const HELP_CENTER_URL = "https://help.yourdomain.com/en/";
export const LOCAL_AGENT_HELP_URL =
  "https://help.yourdomain.com/en/articles/12961920-connecting-a-hackerai-agent-to-your-local-machine";
export const EXTRA_USAGE_HELP_URL =
  "https://help.yourdomain.com/en/articles/13455916-extra-usage-for-paid-hackerai-plans";
export const CANCELLATION_HELP_URL =
  "https://help.yourdomain.com/en/articles/14053370-how-do-i-cancel-my-hackerai-subscription";
export const REFUND_HELP_URL =
  "https://help.yourdomain.com/en/articles/12242991-how-do-i-request-a-refund-for-my-hackerai-subscription";
export const STATUS_PAGE_URL = "https://status.yourdomain.com/";
...
const PAID_PLAN_OFFERS = (
  [
    ["pro", "DARK AI Pro"],
    ["pro-plus", "DARK AI Pro+"],
    ["ultra", "DARK AI Ultra"],
    ["team", "DARK AI Team (per seat)"],
  ] as const
).map(([key, name]) => ({
  "@type": "Offer",
  name,
