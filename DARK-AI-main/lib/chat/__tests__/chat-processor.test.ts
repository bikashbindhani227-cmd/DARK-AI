...
describe("selectModel", () => {
  ...
  it("routes DARK AI Pro through DeepSeek V4 Pro 0813", () => {
  ...
  describe("tier override for ask mode (paid users)", () => {
    it("should map DARK AI Pro to DeepSeek V4 Pro 0813 for text-only ask mode", () => {
      expect(selectModel("ask", "ultra", "hackerai-pro")).toBe(
        "model-deepseek-v4-pro-0813",
      );
    });

    it("should map DARK AI Pro to DeepSeek V4 Pro 0813 for team users", () => {
      expect(selectModel("ask", "team", "hackerai-pro")).toBe(
        "model-deepseek-v4-pro-0813",
      );
    });

    it("should route DARK AI Pro vision to Grok 4.5 high", () => {
      expect(selectModel("ask", "pro", "hackerai-pro", true, false)).toBe(
        "model-grok-4.5-pro",
      );
    });

    it("should keep DARK AI Pro on DeepSeek V4 Pro 0813 when a PDF is attached", () => {
      expect(selectModel("ask", "pro", "hackerai-pro", false, true)).toBe(
        "model-deepseek-v4-pro-0813",
      );
    });

    it("should map DARK AI Standard to DeepSeek V4 Flash 0731 when no image/PDF", () => {
      expect(selectModel("ask", "pro", "hackerai-standard")).toBe(
        "model-deepseek-v4-flash-0731",
      );
    });

    it("should promote DARK AI Standard vision to Grok 4.5 medium", () => {
      expect(selectModel("ask", "pro", "hackerai-standard", true, false)).toBe(
        "model-grok-4.5",
      );
    });

    it("should keep DARK AI Standard on DeepSeek V4 Flash 0731 when a PDF is attached", () => {
      expect(selectModel("ask", "pro", "hackerai-standard", false, true)).toBe(
        "model-deepseek-v4-flash-0731",
      );
    });

    it("should prefer Grok 4.5 medium for DARK AI Standard when image and PDF are both attached", () => {
      expect(selectModel("ask", "pro", "hackerai-standard", true, true)).toBe(
        "model-grok-4.5",
      );
    });

    it("should map DARK AI Max to Grok 4.6 for Ultra", () => {
      expect(selectModel("ask", "ultra", "hackerai-max")).toBe(
        "model-grok-4.6",
      );
    });

    it("should downgrade DARK AI Max to Pro outside Ultra", () => {
    ...
    it("should map DARK AI Max to Grok 4.6 for paid users with extra usage", () => {
      expect(
  ...
  describe("tier override in agent mode", () => {
    it("should map DARK AI Standard to DeepSeek V4 Flash for text-only agent mode", () => {
      expect(selectModel("agent", "pro", "hackerai-standard")).toBe(
        "model-deepseek-v4-flash-0731",
      );
    });

    it("should route DARK AI Standard vision to Grok 4.5 medium", () => {
      expect(
        selectModel("agent", "pro", "hackerai-standard", true, false),
      ).toBe("model-grok-4.5");
    });

    it("should keep DARK AI Standard on DeepSeek V4 Flash when a PDF is attached", () => {
      expect(
        selectModel("agent", "pro", "hackerai-standard", false, true),
      ).toBe("model-deepseek-v4-flash-0731");
    });

    it("should map DARK AI Pro to DeepSeek V4 Pro 0813 in text-only agent mode", () => {
      expect(selectModel("agent", "pro", "hackerai-pro")).toBe(
        "model-deepseek-v4-pro-0813",
      );
    });

    it("should route DARK AI Pro vision to Grok 4.5 high in agent mode", () => {
    ...
    it("should map DARK AI Max to Grok 4.6 in agent mode for Ultra", () => {
      expect(selectModel("agent", "ultra", "hackerai-max")).toBe(
        "model-grok-4.6",
      );
    });

    it("should downgrade DARK AI Max to Pro in agent mode outside Ultra", () => {
    ...
    it("should map DARK AI Max to Grok 4.6 in agent mode for paid users with extra usage", () => {
      expect(
