...
/**
 * Drift guard: every selectable DARK AI tier must resolve to a provider key
...
describe("ModelSelector tier ↔ provider drift", () => {
  ...
  it("DARK AI Standard resolves to DeepSeek V4 Flash in both modes", () => {
  ...
  it("DARK AI Pro resolves to DeepSeek V4 Pro 0813 in both modes", () => {
  ...
  it("DARK AI Max resolves to the same provider in both modes", () => {
  ...
  it("hover-popup descriptions are present for every DARK AI tier", () => {
    const tiered = allOptions.filter((o) => o.label.startsWith("DARK AI"));
  ...
  it("discloses DeepSeek V4 Pro 0813 for DARK AI Pro", () => {
    expect(
  ...
  it("discloses Grok 4.6 for DARK AI Max", () => {
    expect(
