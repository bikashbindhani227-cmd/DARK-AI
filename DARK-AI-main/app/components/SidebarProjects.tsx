...
export function SidebarProjects({
  ...
  const handleNewThread = (project: Doc<"projects">) => {
    if (project.folder_path && !desktopBridgeActive) {
      toast.error("Connect DARK AI Desktop", {
        description: `“${project.name}” is linked to a local folder. Open DARK AI Desktop and wait for it to connect before starting a task.`,
      });
      return;
    }
