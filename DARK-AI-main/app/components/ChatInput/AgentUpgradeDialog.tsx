          ...
          <DialogDescription>
            {isDesktopEnvironment
              ? desktopBridgeStatus === "failed"
                ? "DARK AI Desktop is open, but its local sandbox could not connect."
                : desktopBridgeStatus === "connected"
                  ? "DARK AI Desktop is connected and ready for local Agent mode."
                  : "DARK AI Desktop is connecting its local sandbox."
