...
export const metadata: Metadata = {
  ...
  title: "Terms of Service | DARK AI",
  description: "Terms of Service and conditions for DARK AI services.",
  openGraph: {
    title: "Terms of Service | DARK AI",
    description: "Terms of Service and conditions for DARK AI services.",
    type: "website",
      ...
      <main className="container mx-auto max-w-2xl rounded-md border bg-card px-4 py-8 shadow-lg sm:px-8">
        ...
        <div className="mt-8 space-y-7 text-base leading-relaxed text-card-foreground sm:text-lg">
          <p>
            ...
            between you and DARK AI LLC (&quot;DARK AI,&quot; &quot;we,&quot;
          ...
          <section>
            ...
            <p>
              ...
              trademarks, is owned by DARK AI or its licensors and protected by
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, DARK AI and its
          ...
          <section>
            ...
            <p>
              ...
              indemnify, and hold harmless DARK AI and its affiliates,
          ...
          <section>
            ...
            <p>
              ...
              the state in which DARK AI LLC is organized, without regard to
