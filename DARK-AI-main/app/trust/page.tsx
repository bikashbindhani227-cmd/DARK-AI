...
export const metadata: Metadata = {
  ...
  title: "Security & Trust | DARK AI",
  description:
    "How DARK AI handles your data: AI providers, sandbox execution, storage, billing, account security, and subprocessors.",
  openGraph: {
    title: "Security & Trust | DARK AI",
    description:
      "How DARK AI handles your data: AI providers, sandbox execution, storage, billing, account security, and subprocessors.",
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
            DARK AI is an AI agent for penetration testing and security work.
        ...
        <div className="space-y-6">
          <Section icon={Database} title="Data we process">
            <p>Depending on how you use DARK AI, the service processes:</p>
            <CheckList
              items={[
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Section icon={Bug} title="Responsible disclosure">
              <p>
                Found a security vulnerability in DARK AI? Report it through
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Section icon={Code} title="Source code">
              <p>
                DARK AI is developed in the open. The full application source
                code is public on{" "}
            ...
            <Section icon={BadgeCheck} title="Compliance">
              <p>
                DARK AI doesn&apos;t currently hold SOC 2, ISO 27001, or other
        ...
        <footer className="mt-12">
          ...
          <p className="mt-8 text-center text-xs text-muted-foreground">
            Questions about security at DARK AI? Contact us through the{" "}
