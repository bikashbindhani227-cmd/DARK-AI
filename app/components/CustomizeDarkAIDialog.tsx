...
interface CustomizeDarkAIDialogProps {
  open: boolean;
...
export const CustomizeDarkAIDialog = ({
  open,
  onOpenChange,
}: CustomizeDarkAIDialogProps) => {
        ...
        <div className="flex-1 overflow-y-auto pb-3">
          <div className="space-y-5 pb-3">
            ...
            <div className="flex flex-col gap-2 px-1">
              <Label htmlFor="nickname">What should DARK AI call you?</Label>
              <TextareaAutosize
                id="nickname"
            ...
            <div className="flex flex-col gap-2 px-1">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <Label className="sm:flex-shrink-0">
                  What personality should DARK AI have?
                </Label>
            ...
            {/* Traits */}
            <div className="flex flex-col gap-2 px-1">
              <Label>What traits should DARK AI have?</Label>
            ...
            <div className="flex flex-col gap-3 px-1">
              <Label htmlFor="additional-info">
                Anything else DARK AI should know about you?
              </Label>
              <TextareaAutosize
                id="additional-info"
