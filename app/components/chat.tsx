  ...
  const transportRef = useRef(
    new DefaultChatTransport({
      ...
      prepareSendMessagesRequest: ({ id, messages, body }) => {
        ...
        const requestHeaders = getPostHogRequestHeaders();
        if (authUserIdRef.current) requestHeaders["x-dark-ai-user"] = authUserIdRef.current;
        return {
