...
const FILE_APPROVAL_TITLES: Partial<Record<FileInput["action"], string>> = {
  write: "Allow DARK AI to create this file?",
  append: "Allow DARK AI to append to this file?",
  edit: "Allow DARK AI to edit this file?",
};
  ...
  const renderApprovalRequest = ({
    ...
    <ToolApprovalControls
      ...
      title={
        ...
        "Allow DARK AI to change this file?"
      }
