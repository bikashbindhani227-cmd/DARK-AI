...
const description =
  "See how DARK AI combines security-focused AI, Agent mode, terminal and browser tools, files, and local or cloud execution for penetration testing.";

export const metadata: Metadata = {
  ...canonicalMetadata("/product"),
  title: "Product | DARK AI",
  description,
  openGraph: {
    title: "DARK AI Product",
    description,
    type: "website",
    url: "/product",
...
const capabilities = [
  ...
  },
  {
    ...
    copy: "Drop in reports, screenshots, source, and data. DARK AI works from what you give it instead of guessing at your environment.",
  },
  {
    icon: Search,
...
const expectations = [
  ...
  },
  {
    ...
    copy: "Commands only run on your machine after you connect DARK AI Desktop or the Local Agent CLI.",
  },
  {
        ...
        <section className="border-b border-border/80">
          <div className="mx-auto max-w-6xl px-4 pt-16 pb-14 sm:px-6 sm:pt-24 sm:pb-20">
            ...
            <ZoomableImage
              ...
              alt="DARK AI Agent mode running recon on yourdomain.com: a to-do plan, reasoning, and commands executing in the task"
              width={2240}
              height={1400}
              priority
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className={sectionLead}>
                ...
                DARK AI keeps the whole engagement in one task, from first scan
                to final report.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
            ...
            <div className="mt-12 grid gap-4 lg:grid-cols-3">
              ...
              <article className={card}>
                ...
                <p className="mt-3 leading-7 text-muted-foreground">
                  DARK AI Desktop and the Local Agent CLI connect Agent mode to
        ...
        <section className="border-b border-border/80">
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
            <div className="max-w-2xl">
              ...
              <p className={sectionLead}>
                DARK AI speeds up security work. It does not replace your
        ...
        <section className="border-b border-border/80">
          <div className="mx-auto grid max-w-6xl gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-[1fr_320px] lg:items-center">
            <div className="max-w-2xl">
              ...
              <p className={sectionLead}>
                Start a task in the browser. Install DARK AI Desktop when you
            ...
            <ZoomableImage
              ...
              alt="DARK AI mobile web app running the same recon task on a phone"
              width={780}
              height={1688}
