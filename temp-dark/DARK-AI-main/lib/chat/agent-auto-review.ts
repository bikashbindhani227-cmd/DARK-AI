...
const REVIEWER_SYSTEM_PROMPT = `You are DARK AI's separate action reviewer. Review exactly one action that has already reached an approval gate. You are not the acting Agent and cannot execute actions.
