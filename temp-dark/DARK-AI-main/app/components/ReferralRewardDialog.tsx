          ...
          <>
            <DialogHeader className="flex flex-col gap-4 text-left sm:text-left">
              ...
              <DialogDescription className="sr-only">
                How the DARK AI referral program works and what activity is
              ...
              <ul className="flex list-disc flex-col gap-2 px-5">
                <li>
                  <span className="text-muted-foreground text-sm">
                    Referral links are available to paid DARK AI customers and
                ...
                <li>
                  <span className="text-muted-foreground text-sm">
                    ...
                    and subscribes to any paid DARK AI plan. No credit is
