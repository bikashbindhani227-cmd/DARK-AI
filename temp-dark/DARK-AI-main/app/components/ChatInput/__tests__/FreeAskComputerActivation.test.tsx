...
let mockDetectedPlatform = {
  platform: "macos",
  displayName: "macOS",
  downloadUrl: "https://example.com/DARK AI.dmg",
};
...
describe("FreeAskComputerActivation", () => {
  ...
  it("renders an accessible responsive trigger and captures exposure", async () => {
    ...
    const trigger = screen.getByRole("button", {
      name: "Set up DARK AI Desktop for Agent mode",
    });
    ...
    expect(label).toHaveTextContent("DARK AI Desktop");
  ...
  it("opens desktop and cloud activation paths with analytics", async () => {
    ...
    expect(
      screen.queryByText(
        "Use a desktop computer to download DARK AI Desktop for macOS, Windows, or Linux.",
      ),
    ...
    expect(download).toHaveAttribute(
      "href",
      "https://example.com/DARK AI.dmg",
    );
    expect(download).toHaveAttribute("target", "_blank");
    expect(download).toHaveTextContent("Download DARK AI Desktop");
  ...
  it("does not render inside DARK AI Desktop", () => {
    mockIsTauri = true;
