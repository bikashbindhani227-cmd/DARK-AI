...
export const metadata: Metadata = {
  ...
  title: "Privacy Policy | DARK AI",
  description:
    "Privacy Policy and data handling practices for DARK AI services.",
  openGraph: {
    title: "Privacy Policy | DARK AI",
    description:
      "Privacy Policy and data handling practices for DARK AI services.",
    ...
    <div className="px-4 py-8 pb-16 md:px-0">
      <main className="container mx-auto max-w-2xl rounded-md border bg-card px-4 py-8 shadow-lg sm:px-8">
        ...
        <div className="mt-8 space-y-7 text-base leading-relaxed text-card-foreground sm:text-lg">
          <p>
            This Privacy Policy explains how DARK AI LLC (&quot;DARK AI,&quot;
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              available browser controls and DARK AI&apos;s Cookie settings to
          ...
          <section>
            ...
            <p>
              DARK AI LLC is responsible for the personal information described
              in this policy. For privacy questions or requests, contact us
              through our{" "}
              <a
                href="https://help.yourdomain.com/en/"
                target="_blank"
